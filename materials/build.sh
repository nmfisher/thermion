...
GIZMO_NAME="gizmo"
EXAMPLE_MATERIALS=(customattributes solidcolor viewspace proceduralquad hit_flash hologram hologram_projector force_field force_core dissolve_burn water smoke fire fire_ground lava shockwave_ground shockwave_dome shore_waves sand wetness crystal_ice snow_accumulation damage_decals portal_rift electricity invisibility_cloak energy_weapon noise_showcase)
