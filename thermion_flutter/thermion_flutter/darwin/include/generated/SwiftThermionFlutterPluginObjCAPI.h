...
#ifndef THERMION_FLUTTER_SWIFT_H
#define THERMION_FLUTTER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="thermion_flutter",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC16thermion_flutter26FlutterMetalTextureWrapper")
@interface FlutterMetalTextureWrapper : NSObject
- (nonnull instancetype)initWithTexture:(MetalTextureWrapper * _Nonnull)texture OBJC_DESIGNATED_INITIALIZER;
...
@property (nonatomic, readonly) CVMetalTextureCacheRef _Nullable cvMetalTextureCache;
@property (nonatomic, readonly, strong) id <MTLDevice> _Nullable metalDevice;
@property (nonatomic, readonly) CVMetalTextureRef _Nullable cvMetalTexture;
@property (nonatomic, readonly, strong) id <MTLTexture> _Nullable metalTexture;
@property (nonatomic, readonly) NSInteger metalTextureAddress;
...
+ (NSObject * _Nonnull)textureRegistry SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC16thermion_flutter23ThermionTextureRegistry")
@interface ThermionTextureRegistry : NSObject
- (int64_t)registerTexture:(NSObject * _Nonnull)texture SWIFT_WARN_UNUSED_RESULT;
