...
class ThermionFlutterPluginImpl extends ThermionFlutterPlugin {
  ...
  @override
  Future<PlatformTextureDescriptor?> createTextureAndBindToView(View<dynamic> view, int width, int height) {
    // TODO: implement createTextureAndBindToView
    throw UnimplementedError();
  }

  @override
  Future<ThermionViewer> instanceCreateViewer({bool destroySwapchain = true}) {
    // TODO: implement instanceCreateViewer
    throw UnimplementedError();
  }

  @override
  Future<PlatformTextureDescriptor> resizeTexture(PlatformTextureDescriptor texture, View<dynamic> view, int width, int height) {
    // TODO: implement resizeTexture
    throw UnimplementedError();
  }
  
  @override
  Future<SwapChain<dynamic>> initialize() {
