...
class MetalTextureWrapper extends objc.NSObject {
  ...
  static MetalTextureWrapper allocateWithWidth(int width$1,
      {required int height$1, required bool isDepth, required bool isStencil}) {
...
class SwiftThermionFlutterPluginObjCAPI extends objc.NSObject {
  ...
  static void registerTextureWithTexture(MetalTextureWrapper texture) {
    _objc_msgSend_xtuoz7(_class_SwiftThermionFlutterPluginObjCAPI,
