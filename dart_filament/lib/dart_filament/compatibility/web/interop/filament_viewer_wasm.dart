...
import 'package:dart_filament/dart_filament/compatibility/web/interop/shims/dart_filament_api_js_shim.dart';
...
/// the (Emscripten-generated) DartFilament JS module.
///
class FilamentViewerWasm implements AbstractFilamentViewer {
  ...
  Future initialize(int width, int height, {String? uberArchivePath}) async {
    final context = _module.ccall("dart_filament_web_create_gl_context", "int",
        <JSString>[].toJS, <JSAny>[].toJS, null);
    final loader = _module.ccall(
        "dart_filament_web_get_resource_loader_wrapper",
        "void*",
        <JSString>[].toJS,
        <JSAny>[].toJS,
        null);
