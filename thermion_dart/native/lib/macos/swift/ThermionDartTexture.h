...
#ifndef THERMION_DART_TEXTURE_SWIFT_H
#define THERMION_DART_TEXTURE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="thermion_dart_texture",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC21thermion_dart_texture19ThermionDartTexture")
@interface ThermionDartTexture : NSObject
