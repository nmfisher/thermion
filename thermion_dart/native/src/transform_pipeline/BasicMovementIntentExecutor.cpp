...
//         if (!mTransformManager)
//         {
//             Log("[BasicMovementIntentExecutor] ERROR: No transform manager available");
//             return;
//         }
...
//         {
//             TRACE("[BasicMovementIntentExecutor] ERROR: Invalid transform instance for entity %d", entity.getId());
//             return;
//         }
...
//             TRACE("[BasicMovementIntentExecutor] Entity %d MOVEMENT CALCULATION:", entity.getId());
//             TRACE("[BasicMovementIntentExecutor]   - deltaTime: %.6f seconds", deltaTime);
//             TRACE("[BasicMovementIntentExecutor]   - baseMoveSpeed: %.2f units/s", config.baseMoveSpeed);
...
//                   movementAmount, config.baseMoveSpeed, intent.movementSpeed, deltaTime);
...
//         else
//         {
//             TRACE("[BasicMovementIntentExecutor] Entity %d: No movement intent", entity.getId());
//         }
...
//             TRACE("[BasicMovementIntentExecutor] Entity %d ROTATION:", entity.getId());
//             TRACE("[BasicMovementIntentExecutor]   - mouseDelta.x: %.3f pixels", intent.mouseDelta.x);
//             TRACE("[BasicMovementIntentExecutor]   - invertHorizontal: %s", config.invertHorizontalMovement ? "true" : "false");
//             TRACE("[BasicMovementIntentExecutor]   - mouseSensitivity: %.6f", config.mouseSensitivity);
...
//             TRACE("[BasicMovementIntentExecutor] Entity %d TRANSFORM APPLIED:", entity.getId());
...
//         else
//         {
//             TRACE("[BasicMovementIntentExecutor] Entity %d: No transform applied (no movement or rotation)", entity.getId());
//         }
//     }
