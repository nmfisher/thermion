...
external ffi.Pointer<objc.ObjCObject> _MetalTextureWrapper_protocolTrampoline_1mbt9g9(
  ffi.Pointer<objc.ObjCObject> target,
  ffi.Pointer<ffi.Void> arg0,
);

late final _class_MetalTextureWrapper = objc.getClass("thermion_flutter.MetalTextureWrapper");
...
interface class MTLDevice extends objc.ObjCProtocolBase {
  MTLDevice._(ffi.Pointer<objc.ObjCObject> pointer, {bool retain = false, bool release = false})
    : super(pointer, retain: retain, release: release);

  /// Constructs a [MTLDevice] that points to the same underlying object as [other].
  MTLDevice.castFrom(objc.ObjCObjectBase other) : this._(other.ref.pointer, retain: true, release: true);

  /// Constructs a [MTLDevice] that wraps the given raw object pointer.
  MTLDevice.castFromPointer(ffi.Pointer<objc.ObjCObject> other, {bool retain = false, bool release = false})
...
interface class MTLTexture extends objc.ObjCProtocolBase {
  MTLTexture._(ffi.Pointer<objc.ObjCObject> pointer, {bool retain = false, bool release = false})
    : super(pointer, retain: retain, release: release);

  /// Constructs a [MTLTexture] that points to the same underlying object as [other].
  MTLTexture.castFrom(objc.ObjCObjectBase other) : this._(other.ref.pointer, retain: true, release: true);

  /// Constructs a [MTLTexture] that wraps the given raw object pointer.
  MTLTexture.castFromPointer(ffi.Pointer<objc.ObjCObject> other, {bool retain = false, bool release = false})
    : this._(other, retain: retain, release: release);
}
...
final _objc_msgSend_pysgoz = objc.msgSendPointer
    .cast<ffi.NativeFunction<ffi.Int64 Function(ffi.Pointer<objc.ObjCObject>, ffi.Pointer<objc.ObjCSelector>)>>()
    .asFunction<int Function(ffi.Pointer<objc.ObjCObject>, ffi.Pointer<objc.ObjCSelector>)>();
...
final _objc_msgSend_1v8gk45 = objc.msgSendPointer
    ...
    >();
late final _sel_supportsRenderTarget = objc.registerName("supportsRenderTarget");
...
class MetalTextureWrapper extends objc.NSObject {
  MetalTextureWrapper._(ffi.Pointer<objc.ObjCObject> pointer, {bool retain = false, bool release = false})
    : super.castFromPointer(pointer, retain: retain, release: release);

  /// Constructs a [MetalTextureWrapper] that points to the same underlying object as [other].
  MetalTextureWrapper.castFrom(objc.ObjCObjectBase other) : this._(other.ref.pointer, retain: true, release: true);

  /// Constructs a [MetalTextureWrapper] that wraps the given raw object pointer.
  MetalTextureWrapper.castFromPointer(ffi.Pointer<objc.ObjCObject> other, {bool retain = false, bool release = false})
    : this._(other, retain: retain, release: release);

  /// Returns whether [obj] is an instance of [MetalTextureWrapper].
  static bool isInstance(objc.ObjCObjectBase obj) {
    return _objc_msgSend_19nvye5(obj.ref.pointer, _sel_isKindOfClass_, _class_MetalTextureWrapper);
  }
  ...
  MTLDevice? get metalDevice {
    ...
    return _ret.address == 0 ? null : MTLDevice.castFromPointer(_ret, retain: true, release: true);
  }
  ...
  MTLTexture? get metalTexture {
    ...
    return _ret.address == 0 ? null : MTLTexture.castFromPointer(_ret, retain: true, release: true);
  }
  ...
  static MetalTextureWrapper allocateWithWidth_height_isDepth_isStencil_(
    ...
    return MetalTextureWrapper.castFromPointer(_ret, retain: true, release: true);
  }
  ...
  MetalTextureWrapper init() {
    ...
    return MetalTextureWrapper.castFromPointer(_ret, retain: false, release: true);
  }
  ...
  static MetalTextureWrapper allocWithZone_(ffi.Pointer<objc.NSZone> zone) {
    final _ret = _objc_msgSend_1cwp428(_class_MetalTextureWrapper, _sel_allocWithZone_, zone);
    return MetalTextureWrapper.castFromPointer(_ret, retain: false, release: true);
  }
