...
extension type GeneratedBindings(NativeLibrary _) implements JSObject {
  ...
  external void _OverlayManager_destroy(
    Pointer<TOverlayManager> tOverlayManager,
  );
  external void _OverlayManager_initialize(
    Pointer<TOverlayManager> tOverlayManager,
    int width,
    int height,
    int hardwareTextureId,
  );
  external void _OverlayManager_addHighlight(
    Pointer<TOverlayManager> tOverlayManager,
    EntityId entityId,
  ...
  external void _OverlayManager_removeHighlight(
    Pointer<TOverlayManager> tOverlayManager,
    EntityId entityId,
  );
  external void _OverlayManager_setViewport(
    Pointer<TOverlayManager> tOverlayManager,
    int width,
    int height,
  );
  external void _OverlayManager_setCamera(
    Pointer<TOverlayManager> tOverlayManager,
    Pointer<TCamera> tCamera,
  );
  external Pointer<TView> _OverlayManager_getSilhouetteView(
    Pointer<TOverlayManager> tOverlayManager,
  );
  external Pointer<TView> _OverlayManager_getOverlayView(
    Pointer<TOverlayManager> tOverlayManager,
  );
  external Pointer<TTexture> _OverlayManager_getOverlayTexture(
    Pointer<TOverlayManager> tOverlayManager,
  );
  external int _OverlayManager_hasHighlights(
    Pointer<TOverlayManager> tOverlayManager,
  );
  external int _OverlayManager_isInitialized(
    Pointer<TOverlayManager> tOverlayManager,
  );
  ...
  external void _OverlayManager_createRenderThread(
    Pointer<TEngine> tEngine,
    Pointer<NativeFunction<void Function(PointerClass<TOverlayManager>)>>
        onComplete,
  );
  external void _OverlayManager_initializeRenderThread(
    Pointer<TOverlayManager> tOverlayManager,
    int width,
    int height,
    int hardwareTextureId,
  ...
  external void _OverlayManager_setViewportRenderThread(
    Pointer<TOverlayManager> tOverlayManager,
    int width,
    int height,
    int requestId,
  ...
  external void _OverlayManager_addHighlightRenderThread(
    Pointer<TOverlayManager> tOverlayManager,
    EntityId entityId,
    Pointer<TVertexBuffer> tVertexBuffer,
    Pointer<TIndexBuffer> tIndexBuffer,
  ...
  external void _OverlayManager_removeHighlightRenderThread(
    Pointer<TOverlayManager> tOverlayManager,
    EntityId entityId,
    int requestId,
    VoidCallback onComplete,
  );
  external void _OverlayManager_setCameraRenderThread(
    Pointer<TOverlayManager> tOverlayManager,
    Pointer<TCamera> tCamera,
    int requestId,
    VoidCallback onComplete,
  );
  external void _OverlayManager_destroyRenderThread(
    Pointer<TOverlayManager> tOverlayManager,
    int requestId,
    VoidCallback onComplete,
  );
...
Pointer<TOverlayManager> OverlayManager_create(
  ...
  final result =
      GeneratedBindings.instance._OverlayManager_create(tEngine.cast());
  return Pointer<TOverlayManager>(result);
}
...
void OverlayManager_destroy(
  ...
  final result = GeneratedBindings.instance
      ._OverlayManager_destroy(tOverlayManager.cast());
  return result;
}

void OverlayManager_initialize(
  Pointer<TOverlayManager> tOverlayManager,
  int width,
  int height,
  int hardwareTextureId,
) {
  final result = GeneratedBindings.instance._OverlayManager_initialize(
      tOverlayManager.cast(), width, height, hardwareTextureId);
  return result;
}

void OverlayManager_addHighlight(
  Pointer<TOverlayManager> tOverlayManager,
  DartEntityId entityId,
  Pointer<TVertexBuffer> tVertexBuffer,
  Pointer<TIndexBuffer> tIndexBuffer,
  ...
  final result = GeneratedBindings.instance._OverlayManager_addHighlight(
      tOverlayManager.cast(),
      entityId,
      tVertexBuffer.cast(),
      tIndexBuffer.cast(),
      indexCount,
...
void OverlayManager_removeHighlight(
  Pointer<TOverlayManager> tOverlayManager,
  DartEntityId entityId,
) {
  final result = GeneratedBindings.instance
      ._OverlayManager_removeHighlight(tOverlayManager.cast(), entityId);
  return result;
}

void OverlayManager_setViewport(
  Pointer<TOverlayManager> tOverlayManager,
  int width,
  int height,
) {
  final result = GeneratedBindings.instance
      ._OverlayManager_setViewport(tOverlayManager.cast(), width, height);
  return result;
}

void OverlayManager_setCamera(
  Pointer<TOverlayManager> tOverlayManager,
  Pointer<TCamera> tCamera,
) {
  final result = GeneratedBindings.instance
      ._OverlayManager_setCamera(tOverlayManager.cast(), tCamera.cast());
  return result;
}

Pointer<TView> OverlayManager_getSilhouetteView(
  Pointer<TOverlayManager> tOverlayManager,
) {
  final result = GeneratedBindings.instance
      ._OverlayManager_getSilhouetteView(tOverlayManager.cast());
  return Pointer<TView>(result);
}

Pointer<TView> OverlayManager_getOverlayView(
  Pointer<TOverlayManager> tOverlayManager,
) {
  final result = GeneratedBindings.instance
      ._OverlayManager_getOverlayView(tOverlayManager.cast());
  return Pointer<TView>(result);
}

Pointer<TTexture> OverlayManager_getOverlayTexture(
  Pointer<TOverlayManager> tOverlayManager,
) {
  final result = GeneratedBindings.instance
      ._OverlayManager_getOverlayTexture(tOverlayManager.cast());
  return Pointer<TTexture>(result);
}

bool OverlayManager_hasHighlights(
  Pointer<TOverlayManager> tOverlayManager,
) {
  final result = GeneratedBindings.instance
      ._OverlayManager_hasHighlights(tOverlayManager.cast());
  return result == 1;
}

bool OverlayManager_isInitialized(
  Pointer<TOverlayManager> tOverlayManager,
) {
  final result = GeneratedBindings.instance
      ._OverlayManager_isInitialized(tOverlayManager.cast());
  return result == 1;
}
...
Pointer<TRenderTicker> RenderTicker_create(
  ...
  final result = GeneratedBindings.instance
      ._RenderTicker_create(tEngine.cast(), tRenderer.cast());
  return Pointer<TRenderTicker>(result);
}
...
void RenderTicker_destroy(
  ...
  final result =
      GeneratedBindings.instance._RenderTicker_destroy(tRenderTicker.cast());
  return result;
}
...
void RenderTicker_addAnimationManager(
  ...
  final result = GeneratedBindings.instance._RenderTicker_addAnimationManager(
...
void RenderTicker_removeAnimationManager(
  ...
  final result = GeneratedBindings.instance
      ._RenderTicker_removeAnimationManager(
          tRenderTicker.cast(), tAnimationManager.cast());
  return result;
}
...
void RenderTicker_render(
  ...
  final result = GeneratedBindings.instance
      ._RenderTicker_render(tRenderTicker.cast(), frameTimeInNanos.toJSBigInt);
  return result;
}
...
void RenderTicker_setRenderable(
  ...
  final result = GeneratedBindings.instance._RenderTicker_setRenderable(
...
void RenderTicker_removeSwapChain(
  ...
  final result = GeneratedBindings.instance
      ._RenderTicker_removeSwapChain(tRenderTicker.cast(), swapChain.cast());
  return result;
}
...
void RenderTicker_setOverlayManager(
  ...
  final result = GeneratedBindings.instance._RenderTicker_setOverlayManager(
...
void RenderThread_requestFrameAsync() {
  final result = GeneratedBindings.instance._RenderThread_requestFrameAsync();
  return result;
}
...
void RenderThread_setRenderTicker(
  ...
  final result = GeneratedBindings.instance
      ._RenderThread_setRenderTicker(tRenderTicker.cast());
  return result;
}
...
void RenderTicker_renderRenderThread(
  ...
  final result = GeneratedBindings.instance._RenderTicker_renderRenderThread(
      tRenderTicker.cast(),
...
void OverlayManager_createRenderThread(
  Pointer<TEngine> tEngine,
  Pointer<NativeFunction<void Function(Pointer<TOverlayManager>)>> onComplete,
) {
  final result = GeneratedBindings.instance
      ._OverlayManager_createRenderThread(tEngine.cast(), onComplete.cast());
  return result;
}

void OverlayManager_initializeRenderThread(
  Pointer<TOverlayManager> tOverlayManager,
  int width,
  int height,
  int hardwareTextureId,
  ...
  final result = GeneratedBindings.instance
      ._OverlayManager_initializeRenderThread(
          tOverlayManager.cast(),
          width,
          height,
          hardwareTextureId,
...
void OverlayManager_setViewportRenderThread(
  Pointer<TOverlayManager> tOverlayManager,
  int width,
  int height,
  int requestId,
  ...
  final result = GeneratedBindings.instance
      ._OverlayManager_setViewportRenderThread(
          tOverlayManager.cast(),
          width,
          height,
          requestId,
...
void OverlayManager_addHighlightRenderThread(
  Pointer<TOverlayManager> tOverlayManager,
  DartEntityId entityId,
  Pointer<TVertexBuffer> tVertexBuffer,
  Pointer<TIndexBuffer> tIndexBuffer,
  ...
  final result = GeneratedBindings.instance
      ._OverlayManager_addHighlightRenderThread(
          tOverlayManager.cast(),
          entityId,
          tVertexBuffer.cast(),
          tIndexBuffer.cast(),
...
void OverlayManager_removeHighlightRenderThread(
  Pointer<TOverlayManager> tOverlayManager,
  DartEntityId entityId,
  int requestId,
  DartVoidCallback onComplete,
  ...
  final result = GeneratedBindings.instance
      ._OverlayManager_removeHighlightRenderThread(
          tOverlayManager.cast(),
          entityId,
          requestId,
          onComplete as Pointer<NativeFunction<VoidCallbackFunction>>);
...
void OverlayManager_setCameraRenderThread(
  Pointer<TOverlayManager> tOverlayManager,
  Pointer<TCamera> tCamera,
  int requestId,
  DartVoidCallback onComplete,
  ...
  final result = GeneratedBindings.instance
      ._OverlayManager_setCameraRenderThread(
          tOverlayManager.cast(),
          tCamera.cast(),
          requestId,
          onComplete as Pointer<NativeFunction<VoidCallbackFunction>>);
...
void OverlayManager_destroyRenderThread(
  Pointer<TOverlayManager> tOverlayManager,
  int requestId,
  DartVoidCallback onComplete,
) {
  final result = GeneratedBindings.instance._OverlayManager_destroyRenderThread(
      tOverlayManager.cast(),
      requestId,
      onComplete as Pointer<NativeFunction<VoidCallbackFunction>>);
  return result;
...
final class TOverlayManager extends Struct {
  ...
  static Pointer<TOverlayManager> stackAlloc() {
    return Pointer<TOverlayManager>(
        NativeLibrary.instance.stackAlloc<TOverlayManager>(0));
  }
}
...
final class TRenderTicker extends Struct {
  ...
  static Pointer<TRenderTicker> stackAlloc() {
    return Pointer<TRenderTicker>(
        NativeLibrary.instance.stackAlloc<TRenderTicker>(0));
  }
}
  ...
  static T create<T>() {
    switch (T) {
      ...
      case TSwapChain:
        ...
        return ptr.toDart() as T;
      case TOverlayManager:
        final ptr = TOverlayManager.stackAlloc();
        return ptr.toDart() as T;
      case TRenderTicker:
        final ptr = TRenderTicker.stackAlloc();
        return ptr.toDart() as T;
