...
extension type GeneratedBindings(NativeLibrary _) implements JSObject {
  ...
  external void _ModelImporter_getVertices(
    Pointer<TModelImporter> importer,
    int meshIndex,
    Pointer<PointerClass<Float32>> outVertices,
    Pointer<Int32> outCount,
  );
  external void _ModelImporter_getIndices(
    Pointer<TModelImporter> importer,
    int meshIndex,
    Pointer<PointerClass<Uint32>> outIndices,
    Pointer<Int32> outCount,
  );
  external void _ModelImporter_getNormals(
    Pointer<TModelImporter> importer,
    int meshIndex,
    Pointer<PointerClass<Float32>> outNormals,
    Pointer<Int32> outCount,
  );
  external void _ModelImporter_getUVs(
    Pointer<TModelImporter> importer,
    int meshIndex,
    Pointer<PointerClass<Float32>> outUVs,
    Pointer<Int32> outCount,
  );
  external Pointer<Char> _ModelImporter_getMaterialName(Pointer<TModelImporter> importer, int meshIndex);
  external Pointer<Char> _ModelImporter_getMeshName(Pointer<TModelImporter> importer, int meshIndex);
...
void ModelImporter_getVertices(
  Pointer<TModelImporter> importer,
  int meshIndex,
  Pointer<PointerClass<Float32>> outVertices,
  Pointer<Int32> outCount,
) {
  final result = GeneratedBindings.instance._ModelImporter_getVertices(
    importer.cast(),
    meshIndex,
    outVertices,
    outCount,
...
void ModelImporter_getIndices(
  Pointer<TModelImporter> importer,
  int meshIndex,
  Pointer<PointerClass<Uint32>> outIndices,
  Pointer<Int32> outCount,
) {
  final result = GeneratedBindings.instance._ModelImporter_getIndices(importer.cast(), meshIndex, outIndices, outCount);
  return result;
}

void ModelImporter_getNormals(
  Pointer<TModelImporter> importer,
  int meshIndex,
  Pointer<PointerClass<Float32>> outNormals,
  Pointer<Int32> outCount,
) {
  final result = GeneratedBindings.instance._ModelImporter_getNormals(importer.cast(), meshIndex, outNormals, outCount);
  return result;
}

void ModelImporter_getUVs(
  Pointer<TModelImporter> importer,
  int meshIndex,
  Pointer<PointerClass<Float32>> outUVs,
  Pointer<Int32> outCount,
) {
  final result = GeneratedBindings.instance._ModelImporter_getUVs(importer.cast(), meshIndex, outUVs, outCount);
  return result;
}

Pointer<Char> ModelImporter_getMaterialName(Pointer<TModelImporter> importer, int meshIndex) {
  final result = GeneratedBindings.instance._ModelImporter_getMaterialName(importer.cast(), meshIndex);
  return Pointer<Char>(result);
}

Pointer<Char> ModelImporter_getMeshName(Pointer<TModelImporter> importer, int meshIndex) {
  final result = GeneratedBindings.instance._ModelImporter_getMeshName(importer.cast(), meshIndex);
  return Pointer<Char>(result);
}
