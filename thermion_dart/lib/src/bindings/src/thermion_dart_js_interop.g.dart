...
extension type GeneratedBindings(NativeLibrary _) implements JSObject {
  ...
  external Pointer<TMaterial> _MaterialInstance_getMaterial(Pointer<TMaterialInstance> materialInstance);
  ...
  external size_t _Scene_scanForMaterial(
    Pointer<TScene> tScene,
    Pointer<TRenderableManager> tRenderableManager,
    Pointer<TMaterial> tMaterial,
    Pointer<Int32> outEntities,
    Pointer<Uint32> outPrimitives,
    Pointer<PointerClass<TMaterialInstance>> outInstances,
    size_t capacity,
  );
...
Pointer<TMaterial> MaterialInstance_getMaterial(Pointer<TMaterialInstance> materialInstance) {
  final result = GeneratedBindings.instance._MaterialInstance_getMaterial(materialInstance.cast());
  return Pointer<TMaterial>(result);
}
...
/// [capacity] matches are written to them. Call once with null buffers to
/// size the output, then again to fetch it.
Dartsize_t Scene_scanForMaterial(
  Pointer<TScene> tScene,
  Pointer<TRenderableManager> tRenderableManager,
  Pointer<TMaterial> tMaterial,
  Pointer<Int32> outEntities,
  ...
  final result = GeneratedBindings.instance._Scene_scanForMaterial(
    tScene.cast(),
    tRenderableManager.cast(),
    tMaterial.cast(),
    outEntities,
