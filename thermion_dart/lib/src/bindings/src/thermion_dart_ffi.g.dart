...
@ffi.Native<ffi.Pointer<TSkybox> Function(ffi.Pointer<TEngine>, ffi.Pointer<TTexture>, ffi.Bool, ffi.Float)>(
  isLeaf: true,
)
...
@ffi.Native<
  ffi.Pointer<TSkybox> Function(ffi.Pointer<TEngine>, ffi.Float, ffi.Float, ffi.Float, ffi.Float, ffi.Bool, ffi.Float)
>(isLeaf: true)
