...
@ffi.Native<
  ffi.Pointer<ffi.Uint8> Function(ffi.Pointer<TMeshData>, ffi.Int, ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Int64>)
>(isLeaf: true)
external ffi.Pointer<ffi.Uint8> ModelExporter_exportToBuffer(
  ffi.Pointer<TMeshData> meshes,
  int meshCount,
  ffi.Pointer<ffi.Char> formatId,
  ffi.Pointer<ffi.Int64> outSize,
);

@ffi.Native<ffi.Void Function(ffi.Pointer<ffi.Uint8>)>(isLeaf: true)
external void ModelExporter_disposeBuffer(ffi.Pointer<ffi.Uint8> data);
