...
@ffi.Native<
    ffi.Pointer<TModelImporter> Function(
        ffi.Pointer<ffi.Uint8>, ffi.Int, ffi.Pointer<ffi.Char>)>(isLeaf: true)
...
external int ModelImporter_getMeshCount(
  ffi.Pointer<TModelImporter> importer,
);

@ffi.Native<
    ffi.Void Function(
        ffi.Pointer<TModelImporter>,
        ffi.Int,
...
@ffi.Native<
    ffi.Pointer<ffi.Char> Function(
        ffi.Pointer<TModelImporter>, ffi.Int)>(isLeaf: true)
external ffi.Pointer<ffi.Char> ModelImporter_getMaterialName(
  ffi.Pointer<TModelImporter> importer,
  int meshIndex,
);
...
@ffi.Native<
    ffi.Pointer<ffi.Char> Function(
        ffi.Pointer<TModelImporter>, ffi.Int)>(isLeaf: true)
external ffi.Pointer<ffi.Char> ModelImporter_getMeshName(
  ffi.Pointer<TModelImporter> importer,
  int meshIndex,
);

@ffi.Native<ffi.Void Function(ffi.Pointer<TModelImporter>)>(isLeaf: true)
external void ModelImporter_destroy(
  ffi.Pointer<TModelImporter> importer,
);
