...
@ffi.Native<ffi.Pointer<TOverlayManager> Function(ffi.Pointer<TEngine>)>(
    isLeaf: true)
external ffi.Pointer<TOverlayManager> OverlayManager_create(
  ffi.Pointer<TEngine> tEngine,
);

@ffi.Native<ffi.Void Function(ffi.Pointer<TOverlayManager>)>(isLeaf: true)
external void OverlayManager_destroy(
  ffi.Pointer<TOverlayManager> tOverlayManager,
);

@ffi.Native<
    ffi.Void Function(ffi.Pointer<TOverlayManager>, ffi.Uint32, ffi.Uint32,
        ffi.IntPtr)>(isLeaf: true)
external void OverlayManager_initialize(
  ffi.Pointer<TOverlayManager> tOverlayManager,
  int width,
  int height,
...
@ffi.Native<
    ffi.Void Function(
        ...
        ffi.Float,
        ffi.Float)>(isLeaf: true)
external void OverlayManager_addHighlight(
  ffi.Pointer<TOverlayManager> tOverlayManager,
  int entityId,
...
@ffi.Native<ffi.Void Function(ffi.Pointer<TOverlayManager>, EntityId)>(
    isLeaf: true)
external void OverlayManager_removeHighlight(
  ffi.Pointer<TOverlayManager> tOverlayManager,
  int entityId,
);
...
@ffi.Native<
    ffi.Void Function(
        ffi.Pointer<TOverlayManager>, ffi.Uint32, ffi.Uint32)>(isLeaf: true)
external void OverlayManager_setViewport(
  ffi.Pointer<TOverlayManager> tOverlayManager,
  int width,
  int height,
);
...
@ffi.Native<
    ffi.Void Function(
        ffi.Pointer<TOverlayManager>, ffi.Pointer<TCamera>)>(isLeaf: true)
external void OverlayManager_setCamera(
  ffi.Pointer<TOverlayManager> tOverlayManager,
  ffi.Pointer<TCamera> tCamera,
);

@ffi.Native<ffi.Pointer<TView> Function(ffi.Pointer<TOverlayManager>)>(
    isLeaf: true)
external ffi.Pointer<TView> OverlayManager_getSilhouetteView(
  ffi.Pointer<TOverlayManager> tOverlayManager,
);

@ffi.Native<ffi.Pointer<TView> Function(ffi.Pointer<TOverlayManager>)>(
    isLeaf: true)
external ffi.Pointer<TView> OverlayManager_getOverlayView(
  ffi.Pointer<TOverlayManager> tOverlayManager,
);

@ffi.Native<ffi.Pointer<TTexture> Function(ffi.Pointer<TOverlayManager>)>(
    isLeaf: true)
external ffi.Pointer<TTexture> OverlayManager_getOverlayTexture(
  ffi.Pointer<TOverlayManager> tOverlayManager,
);

@ffi.Native<ffi.Bool Function(ffi.Pointer<TOverlayManager>)>(isLeaf: true)
external bool OverlayManager_hasHighlights(
  ffi.Pointer<TOverlayManager> tOverlayManager,
);

@ffi.Native<ffi.Bool Function(ffi.Pointer<TOverlayManager>)>(isLeaf: true)
external bool OverlayManager_isInitialized(
  ffi.Pointer<TOverlayManager> tOverlayManager,
);
...
@ffi.Native<
    ffi.Void Function(
        ...
        ffi.Pointer<
            ffi.NativeFunction<
                ffi.Void Function(
                    ffi.Pointer<TOverlayManager>)>>)>(isLeaf: true)
external void OverlayManager_createRenderThread(
  ffi.Pointer<TEngine> tEngine,
  ffi.Pointer<
          ffi.NativeFunction<ffi.Void Function(ffi.Pointer<TOverlayManager>)>>
      onComplete,
);

@ffi.Native<
    ffi.Void Function(ffi.Pointer<TOverlayManager>, ffi.Uint32, ffi.Uint32,
        ffi.IntPtr, ffi.Uint32, VoidCallback)>(isLeaf: true)
external void OverlayManager_initializeRenderThread(
  ffi.Pointer<TOverlayManager> tOverlayManager,
  int width,
  int height,
  int hardwareTextureId,
...
@ffi.Native<
    ffi.Void Function(ffi.Pointer<TOverlayManager>, ffi.Uint32, ffi.Uint32,
        ffi.Uint32, VoidCallback)>(isLeaf: true)
external void OverlayManager_setViewportRenderThread(
  ffi.Pointer<TOverlayManager> tOverlayManager,
  int width,
  int height,
  int requestId,
...
@ffi.Native<
    ffi.Void Function(
        ...
        ffi.Uint32,
        VoidCallback)>(isLeaf: true)
external void OverlayManager_addHighlightRenderThread(
  ffi.Pointer<TOverlayManager> tOverlayManager,
  int entityId,
  ffi.Pointer<TVertexBuffer> tVertexBuffer,
  ffi.Pointer<TIndexBuffer> tIndexBuffer,
...
@ffi.Native<
    ffi.Void Function(ffi.Pointer<TOverlayManager>, EntityId, ffi.Uint32,
        VoidCallback)>(isLeaf: true)
external void OverlayManager_removeHighlightRenderThread(
  ffi.Pointer<TOverlayManager> tOverlayManager,
  int entityId,
  int requestId,
  VoidCallback onComplete,
...
@ffi.Native<
    ffi.Void Function(ffi.Pointer<TOverlayManager>, ffi.Pointer<TCamera>,
        ffi.Uint32, VoidCallback)>(isLeaf: true)
external void OverlayManager_setCameraRenderThread(
  ffi.Pointer<TOverlayManager> tOverlayManager,
  ffi.Pointer<TCamera> tCamera,
  int requestId,
  VoidCallback onComplete,
...
@ffi.Native<
    ffi.Void Function(
        ffi.Pointer<TOverlayManager>, ffi.Uint32, VoidCallback)>(isLeaf: true)
external void OverlayManager_destroyRenderThread(
  ffi.Pointer<TOverlayManager> tOverlayManager,
  int requestId,
  VoidCallback onComplete,
);
