...
@ffi.Native<ffi.Void Function(ffi.Uint32, RenderTaskErrorCallback)>(isLeaf: true)
external void RenderThread_setTaskErrorCallback(int requestId, RenderTaskErrorCallback callback);
