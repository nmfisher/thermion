...
class BoneVisualizer {
  ...
  Future<int?> pickBoneAtScreen(int screenX, int screenY,
      {double pickThreshold = 20.0}) async {
    ...
    for (final bone in _bones) {
      ...
      if (bone.boneLength > 0) {
        ...
        final cylinderDist =
            pointToSegmentDistance(mousePos, headScreenPos, tailScreenPos);
  ...
  Future<void> _setEnvelopeTransform(
    ...
    await envelope.setTransform(Matrix4.compose(
      midpoint,
      rotation,
