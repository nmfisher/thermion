---
title: Debugging
description: Diagnose Thermion builds and runtime behavior.
---
...
Unless `mode: debug` is specified in your `pubspec.yaml`, Thermion will use release builds under the hood, even if your app is running in debug mode.
