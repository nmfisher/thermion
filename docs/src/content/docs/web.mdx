---
title: Web
description: Build Thermion for WebAssembly and explore live examples.
---

import ThermionExample from '../../components/ThermionExample.astro';
...
Only one demo runs at a time. Starting another demo releases the previous
WebAssembly renderer before creating the next one.

<ThermionExample example="basics" title="Basics" description="Load a model and orbit the camera." />

<ThermionExample example="geometry" title="Geometry" description="Render procedural geometry." />

<ThermionExample example="materials_and_lighting" title="Materials and lighting" description="Compare materials under animated point lights and shadows." />

<ThermionExample example="animation" title="Animation" description="Play a glTF animation." />

<ThermionExample example="effects" title="Post-processing effects" description="Adjust bloom, FXAA, and color grading live." />
